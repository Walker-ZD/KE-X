...
def test():
    ...
    if 'max_acc' in globals():
        path = osp.dirname(osp.realpath(__file__)) + "/../../model_save/fb15k237_relation" + "_" + str(args.relation_id) + "_" + args.model + "_conv.pt"
...
if args.action == 'explain':
    ...
    save_path = osp.dirname(osp.realpath(__file__)) + "/../../explain_result/fb15k237_relation" + "_" + str(args.relation_id) + "_" + args.model + "_explain_result.json"
    ...
    result_path = osp.dirname(osp.realpath(__file__)) + "/../../explain_result/fb15k237_relation" + "_" + str(args.relation_id) + "_" + args.model + "_explain_result.json"
