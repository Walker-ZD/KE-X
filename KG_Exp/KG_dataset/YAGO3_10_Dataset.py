...
class YAGO3_10_Dataset(InMemoryDataset):

    def __init__(self, root: str, relation_id: int,
                 transform: Optional[Callable] = None,
                 pre_transform: Optional[Callable] = None):

        assert relation_id in range(37)
    ...
    def raw_dataset_dir(self) -> str:
        return osp.join(self.raw_dir, '../../yago3_10')
    ...
    def download(self):
        # print("Enter YAGO3-10 Download function")
        return
    ...
    def entity_type_split(self):
        ...
        graph = globals()["train_graph"] + globals()["test_graph"] + globals()["valid_graph"]
        ...
        total_node = list(globals()['train_node'] + globals()['test_node'])
        import random
        random.shuffle(total_node)
        train_num = int(len(total_node) * 0.9)
        globals()['train_node'] = total_node[: train_num]
        globals()['test_node'] = total_node[train_num :]
    ...
    def __repr__(self) -> str:
        return f'{"YAGO3-10_" + self.relation_name}()'
